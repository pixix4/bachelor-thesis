...
\begin{figure}
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \begin{tikzpicture}[scale=0.4, every node/.style={scale=0.8},>={Latex[length=1.5mm]}]
            ...
            \begin{scope}[color=unimportant]
                ...
                \draw[->] (-5,3.5) -- (-2,3.5);
            \end{scope}
            \draw (-1.5,3.5) circle[radius=0.5];
            \fill (-1.5,3.5) circle[radius=0.35];
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \begin{tikzpicture}[scale=0.4, every node/.style={scale=0.8},>={Latex[length=1.5mm]}]
            ...
            \end{scope}
            \draw (-1.5,3.5) circle[radius=0.5];
            \draw (-1.5,3.5) circle[radius=0.35];
            \draw (-1.5,3) node[anchor=north] {End};
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \begin{tikzpicture}[scale=0.4, every node/.style={scale=0.8},>={Latex[length=1.5mm]}]
            ...
            \draw (-1.2,3.5) circle[radius=0.5];
            \draw (-1.2,3.5) circle[radius=0.35];
