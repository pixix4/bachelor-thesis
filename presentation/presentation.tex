...
\title{\phantom{x}\\Evaluierung der Konsistenz zwischen Business Process Modellen und Business Role-Object Spezifikation}
...
\begin{document}
  ...
  \input{tex/c3_f2}
  \input{tex/c4_f3}
  \input{tex/c5_conclusion}
  \appendix
  \input{tex/c6_appendix}
