...
\begin{lstlisting}[language=Prolog, caption=Regel 1, label=lst:rule_1]
...
\begin{lstlisting}[language=Prolog, caption=Regel 2, label=lst:rule_2]
...
\begin{lstlisting}[language=Prolog, caption=Regel 3, label=lst:rule_3]
...
\begin{lstlisting}[language=Prolog, caption=Regel 4, label=lst:rule_4]
...
\begin{lstlisting}[language=Prolog, caption=Regel 5, label=lst:rule_5]
...
\begin{lstlisting}[language=Prolog, caption=Regel 6, label=lst:rule_6]
