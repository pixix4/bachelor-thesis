\begin{figure}
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \end{tikzpicture}%
        \caption{Regel 3: BPMN-TerminationEvent}%
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \begin{tikzpicture}[scale=0.4, every node/.style={scale=0.8},>={Latex[length=1.5mm]}]
            ...
            \end{scope}
        \end{tikzpicture}%
        \caption{Regel 5: BPMN-StartEvent}%
